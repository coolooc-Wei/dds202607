...
class DeepFingerprinting(nn.Module):
    ...
    def forward(self, x):
        # 1. x 剛進來的形狀: (Batch, window_size, node_num)

        # 2. 轉置維度以符合 PyTorch Conv1d 的要求 (Batch, Channels, Length)
        # 轉置後形狀變成: (Batch, node_num, window_size) -> e.g., (Batch, 8, 10)
        x = x.transpose(1, 2)
...
if __name__ == "__main__":
    ...
    dummy_input = torch.randn(32, 10, 8)
